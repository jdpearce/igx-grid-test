...
@Component({
  selector: 'app-grid',
  styleUrls: ['./grid-boston-marathon.component.scss'],
  templateUrl: './grid-boston-marathon.component.html'
})
export class GridBostonMarathonComponent implements OnInit, OnDestroy {
  ...
  filterTree: IFilteringExpressionsTree;
  ...
  public ngOnInit() {
    ...
    logic.filteringOperands = [
      {
        condition: IgxNumberFilteringOperand.instance().condition(
          'greaterThan'
        ),
        fieldName: 'Id',
        searchVal: 3
